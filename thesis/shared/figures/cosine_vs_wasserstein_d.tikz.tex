...
\begin{scope}[shift={(0,0)}]
  ...
  \begin{axis}[
    ...
    \addplot[amber,fig heavy,dashed] coordinates {(1,0)(3,312.8)};
    \addplot[amber,only marks,mark=*,mark size=1.1pt] coordinates {
      (1,0)(1.25,39.1)(1.5,78.2)(1.75,117.3)(2,156.4)(2.5,234.6)(3,312.8)};
    \node[amber,font=\scriptsize,anchor=west] at (axis cs:1.05,250)
      {Wasserstein rises};
    \node[amber,font=\scriptsize,anchor=west] at (axis cs:1.05,222)
      {with added mass};
  \end{axis}
\end{scope}
