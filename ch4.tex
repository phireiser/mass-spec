...
\textbf{Fifth}, evaluation is intrinsically multi-dimensional, requiring predictive, retrieval-based, and interpretability-oriented criteria. 

Finally and \textbf{sixth}, the empirical contribution of fragment-aware intermediate representations remains difficult to establish conclusively, especially under \emph{small-sample} conditions and in the presence of strong baseline signals from the molecular encoder alone.
