...
\begin{figure}[ht]
    ...
    \caption{Regression of Computation time, excluding molecules that had trival expansions (time $< 40$s).}
...
\begin{figure}[H]
    ...
    \caption{Evaluation metrics: cosine similarity and mean reciprocal rank (MRR).}
...
\begin{figure}[H]
    ...
    \caption{Evaluation metrics: recall at k.}
