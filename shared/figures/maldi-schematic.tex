...
\newcommand{\analyteion}[3]{% x,y,r
  \begin{scope}[shift={(#1,#2)}]
    \draw[Maroon,fig line] (0,0) circle (#3);
    \draw[Maroon,fig thin] (-#3,-#3)--(#3,#3);
    \draw[Maroon,fig thin] (-#3,#3)--(#3,-#3);
    \draw[Maroon,fig hair] (-#3,0)--(#3,0);
    \draw[Maroon,fig hair] (0,-#3)--(0,#3);
  \end{scope}
}
