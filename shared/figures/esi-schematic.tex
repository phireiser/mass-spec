...
\draw[Maroon,fig arrow] (-0.25,0.5) -- (0,0.18);

\node[anchor=east,align=right] at (-0.25,-0.55) {Sample solution};
\draw[Maroon,fig arrow] (-0.25,-0.55) -- (0,-0.25);
...
\begin{scope}
  ...
  \shade[left color=Maroon!85, right color=Maroon!5] (2.1,0.9) rectangle (7.5,-0.9);
  \shade[left color=Maroon!25, right color=white] (5.95,0.9) rectangle (7.5,-0.9);
  ...
  \foreach \x/\y/\r in {
    ...
    \draw[Maroon!70,fig thin,fill=white,fill opacity=0.55]
      (\x,\y) circle [radius=\r];
  }
\end{scope}
...
\draw[Maroon,fig line] (3.2,-0.52) -- (2.1,-2.3);
...
\draw[Maroon,fig arrow] (2.75,-2.6) -- (3.8,-2.6);
...
\draw[Maroon,fig arrow] (4.75,-2.6) -- (5.65,-2.6);
...
\draw[Maroon,fig arrow] (6.95,-2.6) -- (8.15,-2.6);
...
\draw[Maroon,fig arrow] (8.2,1.0) -- (8.2,0.5);
