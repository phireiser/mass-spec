...
``data/outputs/metrics``) and renders four panels: the ceiling distribution,
...
def main() -> None:
    ...
    ap.add_argument("--csv", default=str(ROOT / "data" / "outputs" / "metrics" / "ceiling_per_molecule.csv"))
