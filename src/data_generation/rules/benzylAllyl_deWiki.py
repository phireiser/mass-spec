...
benzylAllyl_mz134_77 = mod.Rule.fromDFS(
	s =
...
benzylAllyl_mz134_91 = mod.Rule.fromDFS(
	s =
	"[C]1[C]2[C]3[C]4[C]5{=}[C]6[C]7{=}[C]8[C]9{=}[C]10{-}5" + # somewhere positive radical +.
	">>" +
...
benzylAllyl_mz91_91_ring = mod.Rule.fromDFS(
	s =
...
benzylAllyl_mz91_65 = mod.Rule.fromDFS(
	# for transparency:
	# https://www.researchgate.net/figure/Cyclopentenium-cation-cyclo-C5H7-or-CP-cyclopentadienyl-cation-cyclo-C5H5-the_fig1_374533853
	s =
	"[c]1{=}[c]2{-}[c]3{=}[c]4{-}[c]5{=}[c]6{-}[c]7{-}1" + #ring positive +
	">>" +
	"[C]1{#}[C]2" "." "[c]3{=}[c]4{-}[c]5{=}[c]6{-}[c]7{-}1", #ring positive +
