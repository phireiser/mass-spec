...
% ---- nozzle / capillary ----
\draw[black,line width=0.8pt] (0,0.35) -- (1.8,0.35) -- (2.1,0.18);
\draw[black,line width=0.8pt] (0,-0.35) -- (1.8,-0.35) -- (2.1,-0.18);
\draw[black,line width=0.8pt] (0,0.06) -- (2.1,0.06);
\draw[black,line width=0.8pt] (0,-0.06) -- (2.1,-0.06);

% voltage probe
\draw[black,line width=0.8pt] (1.25,0.35) -- (1.25,0.8);
\draw[black,line width=0.8pt] (0.95,0.8) -- (1.55,0.8);
\node[above] at (1.25,0.8) {5 kV};

% labels and arrows
\node[anchor=east,align=right] at (-0.25,0.5) {Nebulizer gas};
\draw[msred,->,line width=0.8pt] (-0.25,0.5) -- (0,0.18);

\node[anchor=east,align=right] at (-0.25,-0.55) {Sample solution};
\draw[msred,->,line width=0.8pt] (-0.25,-0.55) -- (0,-0.25);
...
\begin{scope}
  ...
  \foreach \x/\y/\r in {
    ...
    \draw[msred!70,line width=0.6pt,fill=white,fill opacity=0.55]
      (\x,\y) circle [radius=\r];
  }
\end{scope}

% Outer ellipse envelope ONLY (no fill / background)
\draw[black!45,line width=0.8pt] (4.7,0) ellipse [x radius=2.2, y radius=0.7];

% line from ellipse envelope to first droplet
\draw[msred,line width=0.8pt] (3.2,-0.52) -- (2.1,-2.3);

% ---- desolvation / ion formation chain ----
\draw[black!70,fill=black!15,line width=0.8pt] (2.1,-2.6) circle [radius=0.5cm];
...
\draw[msred,->,line width=0.8pt] (2.75,-2.6) -- (3.8,-2.6);

\draw[black!70,fill=black!15,line width=0.8pt] (4.3,-2.6) circle [radius=0.35cm];
...
\draw[msred,->,line width=0.8pt] (4.75,-2.6) -- (5.65,-2.6);
...
\draw[msred,->,line width=0.8pt] (6.95,-2.6) -- (8.15,-2.6);
...
\draw[msred,->,line width=0.8pt] (8.2,1.0) -- (8.2,0.5);

% skimmer / cone stylization (two slits with angled walls)
\draw[black!70,line width=0.8pt] (8,0.8) -- (8.0,0.05);
\draw[black!70,line width=0.8pt] (8,-0.3) -- (8.0,-1.0);

\draw[black!70,line width=0.8pt] (8.5,0.8) -- (8.5,0.15);
\draw[black!70,line width=0.8pt] (8.5,-0.3) -- (8.5,-1);
\draw[black!70,line width=0.8pt] (8.5,0.15) -- (8.35,0.05);
\draw[black!70,line width=0.8pt] (8.5,-0.3) -- (8.35,-0.2);
