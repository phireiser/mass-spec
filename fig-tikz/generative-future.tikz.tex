...
\begin{scope}[shift={(6, 12.10)}]
    % Outer box
    \draw[rounded corners=3pt, genGreen, fig medium, fill=genGreenLL]
    ...
    \begin{scope}[shift={(-3.4, 3.7)}]
        ...
        \node[cloud, draw=genGreen, fig medium, fill=white,
        ...
        \draw[genGreen, fig thin] (cd1)--(cd3) (cd2)--(cd3)
                                          (cd1)--(cd4) (cd2)--(cd4)
                                          (cd1)--(cd2);
    \end{scope}
...
%        \draw[genGreen, fig medium] (-0.35, 0.00) -- (-0.05, 0.00);
%        \draw[genGreen, fig medium] (-0.05, 0.00) -- ( 0.20, 0.22);
%        \draw[genGreen, fig medium] (-0.05, 0.00) -- ( 0.20,-0.22);
%        \draw[genGreen, fig medium] ( 0.20, 0.22) -- ( 0.20,-0.22);
%        % Atoms (small filled green dots with outline)
%        \foreach \x/\y in {-0.35/0.00, -0.05/0.00, 0.20/0.22, 0.20/-0.22} {
%            \draw[genGreen, fig line, fill=genGreen!55]
%                (\x,\y) circle (0.075);
%        }
%    \end{scope}
...
\begin{scope}[shift={(6, 6.0)}]
    % Outer box
    \draw[rounded corners=3pt, scoBlue, fig medium, fill=scoBlueLL]
    ...
    \begin{scope}[shift={(2.0, 0.40)}]
        ...
        \foreach \x/\h in {0.10/0.45, 0.30/0.20, 0.55/0.85, 0.75/0.55, 0.95/0.30,
            ...
            \draw[spectrumBlue, fig medium] (\x, 0) -- (\x, \h);
        }
...
\begin{scope}[shift={(9.4, 2.55)}]
    ...
    \begin{scope}[shift={(-2.4, -0.65)}]
        ...
        \foreach \x/\h in {0.10/0.45, 0.25/0.85, 0.40/0.30, 0.55/0.65, 0.70/0.95,
                          ...
                          1.65/0.50, 1.78/0.25} {
            \draw[spectrumRed, fig medium] (\x, 0) -- (\x, \h);
        }
    \end{scope}
    % Double-ended arrow
