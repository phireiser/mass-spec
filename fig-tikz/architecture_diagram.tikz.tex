...
% ================== ENCODER ROW ==================
\node[encoderNode, below=of MOL]  (EncMol) {$\mathrm{Enc}_{\mathrm{mol}}$\\GCN $3 \rightarrow 64 \rightarrow d$\\Global Pool};
\node[encoderNode, below=of FRAG] (FragSetEnc) {$\mathrm{Enc}_{\mathrm{frag}}$\\Fragment Graph +\\Tree GNN + Pool};
\node[encoderNode, below=of SPEC] (EncSpec) {$\mathrm{Enc}_{\mathrm{spec}}$\\$s_{bins} \rightarrow 512 \rightarrow d$};
...
% ================== DECODER ROW ==================
\node[decoderNode, below=of HdFwd] (DecFrag) {$\mathrm{Dec}_{\mathrm{frag}}$\\$d \to V_{frag}$};
\node[decoderNode, below=of HdBwd] (DecSpec) {$\mathrm{Dec}_{\mathrm{spec}}$\\$d \to 512 \to s_{bins}$};
