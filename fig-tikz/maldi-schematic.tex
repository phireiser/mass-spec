...
\newcommand{\analyteion}[3]{% x,y,r
  \begin{scope}[shift={(#1,#2)}]
    \draw[msred,line width=0.8pt] (0,0) circle (#3);
    \draw[msred,line width=0.55pt] (-#3,-#3)--(#3,#3);
    \draw[msred,line width=0.55pt] (-#3,#3)--(#3,-#3);
    \draw[msred,line width=0.35pt] (-#3,0)--(#3,0);
    \draw[msred,line width=0.35pt] (0,-#3)--(0,#3);
  \end{scope}
}
...
% =========================================================
\draw[black,line width=0.9pt] (0,-2.20) rectangle (0.62,1.55);
...
\foreach \x/\y/\rot/\w/\h in {
  ...
  \begin{scope}[shift={(\x,\y)},rotate=\rot]
    \draw[black,line width=0.8pt,fill=white] (-\w/2,-\h/2) rectangle (\w/2,\h/2);
  \end{scope}
}
...
\foreach \x/\y/\rot in {
  ...
  \begin{scope}[shift={(\x,\y)},rotate=\rot]
    \draw[black,line width=0.85pt,fill=white] (-0.11,-0.35) rectangle (0.11,0.35);
  \end{scope}
}
...
\foreach \dy in {-0.40,-0.20,0.00,0.20,0.40}{
  \draw[black,line width=0.85pt,dash pattern=on 4pt off 4pt]
...
\draw[msred,->,line width=0.9pt] (sam_lab) -- (0.02,-0.55);

\node[align=center] at (2.05,-2.80) (cryst_lab) {Crystallized matrix\\[-10pt]with included analyte};
\draw[msred,->,line width=0.9pt] (cryst_lab) -- (0.92,-0.9);

\node[align=center] at (3.75,-1.60) (mat_lab) {Matrix ions and\\[-10pt]neutrals};
\draw[msred,->,line width=0.9pt] (mat_lab) -- (3.05,-0.70);
\draw[msred,->,line width=0.9pt] (mat_lab) -- (4.15,-0.59);

\node[align=center] at (6.3,-1.6) (a_lab) {Analyte\\[-10pt]ions};
\draw[msred,->,line width=0.9pt] (a_lab) -- (5.85, 0.15);
\draw[msred,->,line width=0.9pt] (a_lab) -- (6.25,-0.75);

\node[anchor=west,align=left] at (6.5,0.5) {Into mass\\[-10pt]analyzer};
\draw[msred,->,line width=0.9pt] (6.10,0.10) -- (7.95,0.10);

\node[align=center] at (2.5,2.5) (uv_lab) {Incoming UV\\[-10pt]laser light};
\draw[msred,->,line width=0.9pt] (uv_lab) -- (4.70,2.20);
