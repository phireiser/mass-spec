...
\tikzset{
  ...
  hb/.style={draw=gridgray,fill=hFill,minimum width=18pt,minimum height=14pt,inner sep=2pt,font=\small\bfseries},
  ...
  dt/.style={dashed,fig medium,color=gridgray}
}
...
\draw[colC!55,fig line]
  (2.72,-4.62)--(3.2,-4.84)--(3.68,-4.62)--(3.68,-4.18)--(3.2,-3.96)--(2.72,-4.18)--cycle;
\draw[colC!55,fig line] (3.68,-4.62)--(4.04,-4.78);
\draw[colC!55,fig line] (2.72,-4.62)--(2.36,-4.88);
...
\draw[gridgray,rounded corners=3pt,fig thin]
...
\draw[colC!55,fig line] (3.66,-8.16)--(4.08,-8.0);
...
%% mol graph s3
\draw[colC!55,fig line] (2.78,-11.62)--(3.28,-11.62);
\draw[colC!55,fig line] (3.28,-11.62)--(3.7,-11.18);
\draw[colC!55,fig line] (3.28,-11.62)--(3.7,-12.02);
...
%%──────────────────── LARGE BLUE ARROW ──────────────────────────────────────
\draw[->, fig xbold, arrB](9.6,-7.95) -- (11.1,-7.95);
...
\draw[fig line,gridgray] (hs1)--(he1);
\draw[fig line,gridgray] (he1)--(hs2);
\draw[fig line,gridgray] (he1)--(hs3);
\draw[fig line,gridgray] (he1)--(hs4);

%% e2 incidence node + links s3 s4 → e2 → s5 s6
\node[hb] (he2) at (17.0,-7.2) {$e_2$};
\draw[fig line,gridgray] (hs3)--(he2);
\draw[fig line,gridgray] (he2)--(hs5);
\draw[fig line,gridgray] (he2)--(hs6);

%% e3 incidence node + links s2 → e3 → s7 s8
\node[hb] (he3) at (13.3,-9.6) {$e_3$};
\draw[fig line,gridgray] (hs2)--(he3);
\draw[fig line,gridgray] (he3)--(hs7);
\draw[fig line,gridgray] (he3)--(hs8);

%%──────────────────── LEGEND ─────────────────────────────────────────────────
\draw[draw=gridgray,dashed,rounded corners=4pt,fill=white]
