...
\tikzset{
  ...
  evO/.style={draw=yellow!60,fill=yellow!26.25,minimum width=#1,minimum height=5pt,inner sep=0pt},
...
%%──────────────────── STAGE 1 BOX ───────────────────────────────────────────
\draw[rounded corners=8pt,fig medium]
...
%%══ ROW 2 – s2 ══════════════════════════════════════════════════════════════
\draw[draw=yellow!80,fill=yellow!12,rounded corners=4pt]
...
%% s2 s3 s4 row
\node[sn=yellow,minimum size=20pt] (hs2) at (13.5,-5.5) {};
\node[font=\scriptsize\bfseries,text=yellow] at (13.5,-5.5) {$s_2$};
