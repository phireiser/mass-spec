...
from ..utils_mod import transform_hyperedge_index
...
class GraphGPSLayer(nn.Module):
    def __init__(self, cfg):
        ...
        # width of edge_attr coming from your featurizer: [e_lbl, bt] -> 2
        self.edge_attr_dim = getattr(cfg, "edge_attr_dim", 2)

        # NEW: edge feature encoder to match GENConv’s requirement
        self.edge_encoder = nn.Sequential(
            nn.Linear(self.edge_attr_dim, self.dim_h),
            nn.GELU(),
