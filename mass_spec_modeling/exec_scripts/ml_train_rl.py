...
MOL_DEF_PATH = "/home/mescalin/reiserp/Nextcloud/studium/computationalScience/thesis/mol/" \
            + "mass_spec_modeling/exec_scripts/run_data.csv"
LOAD_PATH = "/home/mescalin/reiserp/Nextcloud/studium/computationalScience/thesis/mol/dump/"
ROOT_NODE_ID = 0
...
for name, smi in mols_definitions:
    ...
    dg, rdb = utils.load_derivation_graph(mol.name, path=LOAD_PATH)
