...
| `-r 0` (hydrogens kept) | 8 s / 191 | explodes | — |
...
|---|---|---|---|---|
| concrete | 16 s / 111 | 4 s / 60 | 34 s / 73 | *see §7* |
| `-r 1` (hydrogens kept) | 32 s / 427 | 4 s / 63 | 34 s / 199 | *see §7* |
...
*Pending — filled in from the `--context-radius 1` corpus run.*
