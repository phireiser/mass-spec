hTransition_saturated_1 = Rule.formDFS(
	s=
	"[H]1[C]2[C]4[O+.]5[C]6" +
	">>" +
	"[C.]2[C]4[O+]5([H]1)([C]6)",
...
hTransition_saturated_1_inductive_2 = Rule.formDFS(
	s = 
	"[C.]2[C]4[O+]5([H]1)([C]6)" +
	">>" +
	"[C]2[C+.]4{-}2.[O+.]5([H]1)([C]6)",
...
hTransition_saturated_3 = Rule.fromDFS( # siehe 4.44 & 4.46
	s = 
	"[H]1[C]2[C]4[O+]5{=}[C]6([H]7)([C]8)" +
	">>" +
	"[C.]2[C]4[O+]5([H]1){=}[C]6([H]7)([C]8)",
	name =
	"H transition receptor site saturated rH" +
	" ^S2-4Y5R8"
)
...
hTransition_saturated_3_alpha = Rule.fromDFS( # siehe 4.44 & 4.46
	...
	"[C.]2[C]4[O+]5([H]1){=}[C]6([H]7)([C]8)" +
	">>" +
	"[C]2[C]4{-}2.[O+.]5([H]1){=}[C]6([H]7)([C]8)",
	name =
	"H transition receptor site saturated alpha" + 
	" ^S2-4Y5R8"
)

hTransition_saturated_4 = Rule.formDFS( # siehe 8.90
	s =
	"[H]1[C]2[C]4[C]5([H]6){=}[O+]7[C]8" +
	">>" +
	"[C.]2[C]4[C]5([H]6)([H]1){=}[O+]7[C]8",
	name =
	"H transition receptor site saturated rH" +
	" ^Y7S2-4R8"
)
...
hTransition_saturated_4_alpha = Rule.fromDFS( # siehe 8.90
	s =
	"[C.]2[C]4[C]5([H]7)([H]1){=}[O+]6[C]8" +
	">>" +
	"[C]2[C]4{-}2.[C]5([H]7)([H]1){=}[O+.]6[C]8",
	name =
	"H transition receptor site saturated alpha"
)
...
hTransition_saturated_5 = Rule.fromDFS( # siehe 4.45
	s = 
	"[H]1[C]2([O+]7)[C]4[O..]5[C]6" +
	">>" +
	"[C]2([O+]7)[C]4[O..]5([H]1)[C]6",
	name =
	"H transition receptor site saturated rH" +
	" ^Y7S2-4Y5R6"
)
