...
benzylAlly_mz92_91 = Rule.fromDFS(
	"[H]1[C]2[C]3{=}[C]4[C]5{=}[C]6[C]7{=}[C]8{-}3" + #somewhere positive radical +.
	">>" +
	"[H.]1.[C+]2[C]3{=}[C]4[C]5{=}[C]6[C]7{=}[C]8{-}3"
)

benzylAlly_mz91_91 = Rule.fromDFS( #ring
...
benzylAlly_mz65_39 = Rule.fromDFS( 
	# assumption: https://en.wikipedia.org/wiki/Propargyl_group
