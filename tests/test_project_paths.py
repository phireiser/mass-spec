...
class TestProjectPaths(unittest.TestCase):
    def test_shared_paths_resolve_inside_repo(self):
        ...
        self.assertEqual(shared_path("NIST_SPECTRA_DIR_REL"), repo_path("data", "nist_spectra"))
        self.assertEqual(shared_path("BEST_PARAMS_DIR_REL"), repo_path("outputs", "best_params"))
